    ...
    for index, row in pairs(self.matrix) do
        for index2, column in pairs(self.matrix[row]) do
            if self.matrix[row][column-1] then
                self.matrix[row][column].child.top = self.matrix[row][column-1]
            end
            if self.matrix[row][column+1] then
                self.matrix[row][column].child.bottom = self.matrix[row][column+1]
            end
            if self.matrix[row-1] then
                if self.matrix[row-1][column] then
                    self.matrix[row][column].child.left = self.matrix[row-1][column]
                end
            end
            if self.matrix[row+1] then
                if self.matrix[row+1][column] then
                    self.matrix[row][column].child.right = self.matrix[row+1][column]
                end
            end
        end
    end
        ...
        for index2, column in pairs(self.matrix[row]) do
            ...
            if self.matrix[row-1] then
                if self.matrix[row-1][column] then
                 ...
                 self.matrix[row][column].child.left = self.matrix[#self.matrix][column]
            end
            if self.matrix[row+1] then
                if self.matrix[row-1][column] then
                    self.matrix[row][column].child.right = self.matrix[row+1][column]
                 ...
                 self.matrix[row][column].child.right = self.matrix[1][column]
            end
        end
    end
end